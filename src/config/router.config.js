...

  {
    ...
    children: [
      // dashboard
      {
        ...
        children: [
          ...
          },
          {
            ...
            meta: {title: '监控页', permission: ['Pages.Dashboards']}
          },
          {
            path: '/dashboard/workplace',
            name: 'Workplace',
            component: () => import('@/views/dashboard/Workplace'),
            meta: {title: '工作台', permission: ['Pages.Dashboards']}
          }
        ]
      },
      ...
      // forms
      {
        ...
        component: PageView,
        meta: {title: '表单页', icon: 'form', permission: ['Pages.Users', 'Pages.Roles']},
        children: [
          {
            path: '/form/base-form',
            name: 'BaseForm',
            component: () => import('@/views/form/BasicForm'),
            meta: {title: '基础表单', permission: ['Pages.Users', 'Pages.Roles']}
          },
          {
            path: '/form/step-form',
            name: 'StepForm',
            component: () => import('@/views/form/stepForm/StepForm'),
            meta: {title: '分步表单', permission: ['Pages.Users', 'Pages.Roles']}
          },
          {
            path: '/form/advanced-form',
            name: 'AdvanceForm',
            component: () => import('@/views/form/advancedForm/AdvancedForm'),
            meta: {title: '高级表单', permission: ['Pages.Users', 'Pages.Roles']}
          }
        ]
      },
      ...
      // list
      {
        ...
        meta: {title: '列表页', icon: 'table', permission: ['Pages.Users', 'Pages.Roles']},
        children: [
          {
            path: '/list/query-list',
            name: 'QueryList',
            component: () => import('@/views/list/TableList'),
            meta: {title: '查询表格', permission: ['Pages.Users', 'Pages.Roles']}
          },
          {
            path: '/list/edit-table',
            name: 'EditList',
            component: () => import('@/views/list/TableInnerEditList'),
            meta: {title: '内联编辑表格', permission: ['Pages.Users', 'Pages.Roles']}
          },
          {
            path: '/list/users-list',
            name: 'UserList',
            component: () => import('@/views/list/UserList'),
            meta: {title: '用户列表', permission: ['Pages.Users', 'Pages.Roles']}
          },
          {
            path: '/list/role-list',
            name: 'RoleList',
            component: () => import('@/views/list/RoleList'),
            meta: {title: '角色列表', permission: ['Pages.Users', 'Pages.Roles']}
          },
          {
            path: '/list/permission-list',
            name: 'PermissionList',
            component: () => import('@/views/list/PermissionList'),
            meta: {title: '权限列表', permission: ['Pages.Users', 'Pages.Roles']}
          },
          {
            path: '/list/basic-list',
            name: 'BasicList',
            component: () => import('@/views/list/StandardList'),
            meta: {title: '标准列表', permission: ['Pages.Users', 'Pages.Roles']}
          },
          {
            path: '/list/card',
            name: 'CardList',
            component: () => import('@/views/list/CardList'),
            meta: {title: '卡片列表', permission: ['Pages.Users', 'Pages.Roles']}
          },
          {
            path: '/list/search',
            name: 'SearchList',
            ...
            meta: {title: '搜索列表', permission: ['Pages.Users', 'Pages.Roles']},
            children: [
              {
                path: '/list/search/article',
                name: 'SearchArticles',
                component: () => import('../views/list/TableList'),
                meta: {title: '搜索列表（文章）', permission: ['Pages.Users', 'Pages.Roles']}
              },
              {
                path: '/list/search/project',
                name: 'SearchProjects',
                component: () => import('../views/list/TableList'),
                meta: {title: '搜索列表（项目）', permission: ['Pages.Users', 'Pages.Roles']}
              },
              {
                path: '/list/search/application',
                name: 'SearchApplications',
                component: () => import('../views/list/TableList'),
                meta: {title: '搜索列表（应用）', permission: ['Pages.Users', 'Pages.Roles']}
              },
            ]
          },
        ]
      ...
      // profile
      {
        ...
        meta: {title: '详情页', icon: 'profile', permission: ['Pages.Users', 'Pages.Roles']},
        children: [
          {
            path: '/profile/basic',
            name: 'ProfileBasic',
      ...
      // result
      {
        ...
        meta: {title: '结果页', icon: 'check-circle-o', permission: ['Pages.Users', 'Pages.Roles']},
        children: [
          {
            path: '/result/success',
            name: 'ResultSuccess',
      ...
      // Exception
      {
        ...
        meta: {title: '异常页', icon: 'warning', permission: ['Pages.Users', 'Pages.Roles']},
        children: [
          {
            path: '/exception/403',
            name: 'Exception403',
